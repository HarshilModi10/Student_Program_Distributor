...
testStudents = [student1, student2, student3, student4, student5, student6,
    student7, student8]
...
testFreeStudents = ["student4", "student5", "student8"]

allocatedStudents = allocate(testStudents, testFreeStudents, testCapacities)

def test_sort():
    expectedSort = [student2, student6, student1, student4, student5, student7, 
        student3, student8]
...
def test_allocate_four_gpa_unallocated_free():
    assert (student5 not in allocatedStudents["chemical"]
            and student5 not in allocatedStudents["materials"]
            and student5 not in allocatedStudents["engphys"])

def test_allocate_four_gpa_unallocated_not_free():
    assert (student7 not in allocatedStudents["chemical"]
            and student7 not in allocatedStudents["software"]
            and student7 not in allocatedStudents["engphys"])

def test_allocate_less_than_four_gpa_unallocated_free():
    assert (student8 not in allocatedStudents["chemical"]
...
def test_allocate_less_than_four_gpa_unallocated_not_free():
    assert (student3 not in allocatedStudents["software"]
            and student3 not in allocatedStudents["electrical"]
            and student3 not in allocatedStudents["civil"])
